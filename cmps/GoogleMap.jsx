...
export function GoogleMap({ stayLoc }) {
  const CustomMarker = ({ homeIcon }) => (
    <div className='home-marker'>
      <svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style={{ display: 'block', height: '22px', width: '22px', fill: '#fff' }}>
      ...
      <img src={homeIcon} alt="Home Icon" style={{ width: '100%', height: '100%', position: 'absolute', top: 0, left: 0 }} />
    </div>
  );
