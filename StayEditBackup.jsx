        ...
        <section className="stay-edit" >
            ...
            <form onSubmit={handleSubmit} >
                ...
                <div className="checkbox-list">
                    {amentities.Essentials.map(amentity => <div className='checkbox-item'><input key={amentity} onChange={handleAmentityChange} type="checkbox" className='Essentials amentities' name={amentity} /><span>{amentity}</span></div>)}
                </div>
                <h4>Features</h4>
                <div className="checkbox-list">
                    {amentities.Features.map(amentity => <div className='checkbox-item'><input key={amentity} onChange={handleAmentityChange} type="checkbox" name={amentity} className='Features amentities' /><span>{amentity}</span></div>)}
                </div>
                <h4>Location</h4>
                <div className="checkbox-list">
                    {amentities.Location.map(amentity => <div className='checkbox-item'><input key={amentity} onChange={handleAmentityChange} type="checkbox" name={amentity} className='Location amentities' /><span>{amentity}</span> </div>)}
                </div>
                <h4>Safty</h4>
                <div className="checkbox-list">
                    {amentities.Safty.map(amentity => <div className='checkbox-item'><input key={amentity} onChange={handleAmentityChange} type="checkbox" name={amentity} className='Safty amentities' /><span>{amentity}</span></div>)}
                </div>
